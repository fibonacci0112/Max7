...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 105.0, 347.0, 163.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 550.0, 168.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.0, 208.5, 77.0, 22.0 ],
					"style" : "",
					"text" : "attraction $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 383.0, 367.0, 298.0, 36.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 383.0, 314.0, 100.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 383.0, 266.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "jit.gen update"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 550.0, 115.0, 147.0, 22.0 ],
					"presentation_rect" : [ 550.0, 116.0, 0.0, 0.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 410.0, 220.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "jit.gen force"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.0, 76.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "r metro"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.0, 240.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "s metro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 383.0, 169.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 383.0, 115.0, 147.0, 22.0 ],
					"style" : "",
					"text" : "jit.noise 3 float32 250 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 383.0, 42.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 101.0, 273.0, 225.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 101.0, 220.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 101.0, 168.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 33"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 847.0, 159.0, 248.0, 130.0 ],
					"varname" : "embossr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 847.0, -17.0, 356.0, 154.0 ],
					"prototypename" : "pixl",
					"varname" : "grabbr",
					"viewvisibility" : 1
				}
